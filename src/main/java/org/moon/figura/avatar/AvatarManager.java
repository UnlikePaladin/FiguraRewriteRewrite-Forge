...
public class AvatarManager {
    ...
    public static LiteralArgumentBuilder<CommandSourceStack> getCommand() {
        //root
        LiteralArgumentBuilder<CommandSourceStack> root = LiteralArgumentBuilder.literal("set_avatar");
        ...
        source.executes(context -> {
            ...
            try {
                ...
                context.getSource().sendFailure(Component.literal("Failed to parse uuids"));
                return 0;
            }
            ...
            if (avatar == null || avatar.nbt == null) {
                context.getSource().sendFailure(Component.literal("No source Avatar found"));
                return 0;
            }
            ...
            if (targetEntity == null) {
                context.getSource().sendFailure(Component.literal("Target entity not found"));
                return 0;
            }
